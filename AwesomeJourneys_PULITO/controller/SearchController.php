...
class SearchController {
    ...
    public function searchStays(){
        session_start();
        if(isset($_SESSION['utente'])){
            $searchResult = new StaySearchResult();
            $searchResult->searchStay();
            
            $user = unserialize($_SESSION['utente']);
            $user->setStaySearchResult($searchResult);
            $_SESSION['utente'] = serialize($user);
    ...
    public function searchActivities(){
        session_start();
        if(isset($_SESSION['utente'])){
            $searchResult = new ActivitySearchResult();
            $searchResult->search();
            
            $user = unserialize($_SESSION['utente']);
            $user->setActivitySearchResult($searchResult);
            $_SESSION['utente'] = serialize($user);

...
abstract class UserComponent{   
    public static function login($mail, $pass){
        ...
        if($us != FALSE){
            ...
            session_start();
            if($us->role == 'customer')
                $user = self::concreteUserComponent(session_id (), $us->mail, $us->name, $us->surname, $us->address, $us->telephone);
            else
                $user = self::travelAgent(session_id (), $us->mail, $us->name, $us->surname, $us->address, $us->telephone);
